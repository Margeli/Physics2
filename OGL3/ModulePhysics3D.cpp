...
bool ModulePhysics3D::CleanUp()
{
	...
	for (p2List_item<PhysBody3D*>*pbody = bodies.getFirst(); pbody != nullptr; pbody = pbody->next) {
		bodies.del(pbody);
	}
	for (p2List_item<btCollisionShape*>*coll = shapes.getFirst(); coll!= nullptr; coll = coll->next) {
		shapes.del(coll);
	}
